...
class ConfigurationLoader:
    ...
    when the application is running. Used by py to manage all the
    ...
    def parse_arguments(self):
        ...
        # Top level parser
        reader = argparse.ArgumentParser(description="")
        ...
        scan_parser = subparsers.add_parser('scan',
                                            help='Perform a network scan. Check \'python py scan '
        ...
        sniff_parser = subparsers.add_parser('sniff',
                                             help='Perform a sniffing. '
                                                  'Check \'python py sniff --help\' for more details',
                                             formatter_class=argparse.RawTextHelpFormatter)
